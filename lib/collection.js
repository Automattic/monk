...
function Collection (manager, name, options) {
  ...
  this.estimatedDocumentCount = this.estimatedDocumentCount.bind(this)
...
Collection.prototype.count = function (query, opts, fn) {
  ...
  return this._dispatch(function count (args) {
    return args.col.countDocuments(args.query, args.options)
...
Collection.prototype.estimatedDocumentCount = function (opts, fn) {
  if (typeof opts === 'function') {
    fn = opts
    opts = {}
  }

  return this._dispatch(function estimatedDocumentCount (args) {
    return args.col.estimatedDocumentCount(args.options)
  })({options: opts, callback: fn}, 'count')
}
...
Collection.prototype.insert = function (data, opts, fn) {
  ...
  return this._dispatch(function insert (args) {
    ...
    return insertop.then(function (docs) {
      var res = (docs || {}).ops
      if (res && !arrayInsert) {
        res = docs.ops[0]
      }

...
Collection.prototype.replaceOne = function (query, replacement, opts, fn) {
  if (typeof opts === 'function') {
    fn = opts
    opts = {}
  }

  return this._dispatch(function replaceOne (args) {
    return args.col.replaceOne(args.query, args.replacement, args.options).then(function (doc) {
      return (doc && doc.result) || doc
    })
  })({replacement: replacement, query: query, options: opts, callback: fn}, 'replaceOne')
}

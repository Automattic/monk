 ...
 */
Collection.prototype.group = function(keys, query, initial, reduce, fn) {
    query = this.cast(query);

    var promise = new Promise(this, 'group');
    promise.keys = keys;
    promise.query = query;
    ...
    this.col.group(keys, query, initial, reduce, false, callback);
